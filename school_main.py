...
TEXTS = {
    "welcome_first": {
        ...
        "uz": "Assalomu alaykum! Thompson International School Land taklif va shikoyatlar bo‘yicha yordamchisiman.\n\nIltimos, tilni tanlang:"
    },
    "contact": {
...
def handle_input(message):
    ...
    text_for_group = (
        f"NEW Thompson International School FEEDBACK [{lang.upper()}]\n"
        f"Тип: {category}\n"
